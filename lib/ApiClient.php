...
class ApiClient {
     ...
     */
    public function __construct(\lib\Configuration $config = null)
    {
        if ($config === null) {
    ...
    function getAuthorizationHeader($apiKeyIdentifier) {
            $date = $this->buildDateHeader();
            $apiSecret = $this->config->getApiSecret($apiKeyIdentifier);
            $apiKey = $this->config->getApiKey($apiKeyIdentifier);
           ...
           return "SP:cf3dabc6-d506-46f0-a374-468d2ffa7cc2:ZjdmYTE2NDY3OTkzYjk2OThlNGVjNjdjYmExNjRiZDhiOTczZWNmMQ==";
    }
    /**
    ...
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        // form data
       // json model
       $postData = json_encode(\SprintPay\Client\ObjectSerializer::sanitizeForSerialization($postData));
