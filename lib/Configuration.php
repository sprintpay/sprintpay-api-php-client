...
class Configuration {
     ...
     * @var string[]
     */
    protected $apiKeys = array("sprintpay"=>"feb1bdd9-6605-4933-ba13-b0c79e6d372a");
    /**
     * Associate array to store API Secret key(s)
     *
     * @var string[]
     */
    protected  $apiSecret = array("sprintpay"=>"cdc79c16-f127-4cfb-9b89-47ed885c0f4c");
    /**
     ...
     * @var string
     */
    protected $host = 'http://197.159.2.146:7086/sprintpayapi/';
     ...
     * @var string
     */
    protected $curlConnectTimeout = 300;
     ...
     * @var string
     */
    protected $userAgent = 'Sprint-pay/1.0.0/php';
     ...
     * @return $this
     */
    public function setApiSecret($apiKeyIdentifier, $key)
    {
        $this->apiSecret[$apiKeyIdentifier] = $key;
        return $this;
    }
     ...
     * @return string API key or token
     */
    public function getApiSecret($apiKeyIdentifier)
    {
        return isset($this->apiKeys[$apiKeyIdentifier]) ? $this->apiKeys[$apiKeyIdentifier] : null;
    } 
