...
class Configuration
{
    ...
    /**
     * User agent of the HTTP request, set to "PHP-SprintPay" by default
     *
     * @var string
     */
    protected $userAgent = 'SprintPay-Codegen/1.0.0/php';
     ...
     * @return $this
     */
    public function setApiKeyParameter($apiKeyIdentifier, $key)
    {
    ...
    {
        $report  = 'PHP SDK (SprintPay\Client) Debug Report:' . PHP_EOL;
